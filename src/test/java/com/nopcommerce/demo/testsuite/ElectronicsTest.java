...
public class ElectronicsTest extends BaseTest{
    ...
    public void verifyThatTheProductAddedSuccessfullyAndPlaceOrderSuccessfully() throws InterruptedException {
        ...
        electronicsPage.sendText(electronicsPage.firstName, "Jagruti");
        electronicsPage.sendText(electronicsPage.lastName, "Jadeja");
        electronicsPage.sendText(electronicsPage.emailId, electronicsPage.generateEmailId());
        electronicsPage.select(electronicsPage.date, "22");
        electronicsPage.select(electronicsPage.month, "9");
        electronicsPage.select(electronicsPage.year, "1988");
        electronicsPage.sendText(electronicsPage.password, "jagruti2209");
        electronicsPage.sendText(electronicsPage.confirmPassword, "jagruti2209");
        //2.21 Click on “REGISTER” Button
        ...
        electronicsPage.sendText(electronicsPage.cityName, "MiltonKeynes");
        electronicsPage.sendText(electronicsPage.address1, "6 Falcon");
        electronicsPage.sendText(electronicsPage.postalCode, "Mk63HH");
        electronicsPage.sendText(electronicsPage.phoneNumber, "07424699630");
        //2.28 Click on “CONTINUE”
        ...
        //2.33 Fill all the details
        electronicsPage.sendText(electronicsPage.cardHolderName, "jagruti Jadeja");
        ...
        electronicsPage.sendText(electronicsPage.cardCode, "888");
        //2.34 Click on “CONTINUE”
